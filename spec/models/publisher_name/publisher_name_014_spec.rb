...
# Auto-generated random-input case 014 of 100.
...
RSpec.describe Publisher, type: :model do
  it "is valid with a random name (case 014)" do
    expect(build(:publisher, name: "Rohan, Zieme and Nader 7b5871")).to be_valid
  end
end
