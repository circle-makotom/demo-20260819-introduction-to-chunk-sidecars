...
# Auto-generated random-input case 072 of 100.
...
RSpec.describe Publisher, type: :model do
  it "is valid with a random name (case 072)" do
    expect(build(:publisher, name: "Mosciski, Haag and Marks 555673")).to be_valid
  end
end
