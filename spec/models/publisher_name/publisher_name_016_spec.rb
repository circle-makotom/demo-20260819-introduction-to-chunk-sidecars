...
# Auto-generated random-input case 016 of 100.
...
RSpec.describe Publisher, type: :model do
  it "is valid with a random name (case 016)" do
    expect(build(:publisher, name: "Wilkinson and Sons 52ebf2")).to be_valid
  end
end
