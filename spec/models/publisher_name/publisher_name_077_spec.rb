...
# Auto-generated random-input case 077 of 100.
...
RSpec.describe Publisher, type: :model do
  it "is valid with a random name (case 077)" do
    expect(build(:publisher, name: "Stoltenberg-Kuvalis 4578ba")).to be_valid
  end
end
