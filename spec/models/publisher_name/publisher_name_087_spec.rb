...
# Auto-generated random-input case 087 of 100.
...
RSpec.describe Publisher, type: :model do
  it "is valid with a random name (case 087)" do
    expect(build(:publisher, name: "Jacobs-Christiansen dd80bc")).to be_valid
  end
end
