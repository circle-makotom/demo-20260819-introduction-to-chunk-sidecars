...
# Auto-generated random-input case 054 of 100.
...
RSpec.describe Publisher, type: :model do
  it "is valid with a random name (case 054)" do
    expect(build(:publisher, name: "Pouros, Braun and Howe f8714f")).to be_valid
  end
end
