...
# Auto-generated random-input case 025 of 100.
...
RSpec.describe Publisher, type: :model do
  it "is valid with a random name (case 025)" do
    expect(build(:publisher, name: "Paucek, Witting and Powlowski 495375")).to be_valid
  end
end
