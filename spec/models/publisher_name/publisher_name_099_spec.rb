...
# Auto-generated random-input case 099 of 100.
...
RSpec.describe Publisher, type: :model do
  it "is valid with a random name (case 099)" do
    expect(build(:publisher, name: "Trantow, Hilll and Breitenberg f3fb60")).to be_valid
  end
end
