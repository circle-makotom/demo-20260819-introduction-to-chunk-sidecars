...
# Auto-generated random-input case 021 of 100.
...
RSpec.describe Publisher, type: :model do
  it "is valid with a random name (case 021)" do
    expect(build(:publisher, name: "Dickinson, Wyman and Turner eac8e5")).to be_valid
  end
end
