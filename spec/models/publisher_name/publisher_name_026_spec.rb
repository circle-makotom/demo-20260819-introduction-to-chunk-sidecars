...
# Auto-generated random-input case 026 of 100.
...
RSpec.describe Publisher, type: :model do
  it "is valid with a random name (case 026)" do
    expect(build(:publisher, name: "Greenfelder, Daugherty and Schultz 695efc")).to be_valid
  end
end
