...
# Auto-generated random-input case 031 of 100.
...
RSpec.describe Publisher, type: :model do
  it "is valid with a random name (case 031)" do
    expect(build(:publisher, name: "Beer, Boyer and Miller 6d2c28")).to be_valid
  end
end
