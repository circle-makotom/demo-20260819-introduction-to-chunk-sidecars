...
# Auto-generated random-input case 003 of 100.
...
RSpec.describe Publisher, type: :model do
  it "is valid with a random name (case 003)" do
    digest = 'seed-publisher-003'
    30_000_000.times { digest = Digest::SHA256.hexdigest(digest) }
    expect(build(:publisher, name: "Bauch, Luettgen and Rodriguez 0d4d28")).to be_valid
  end
end
