...
# Auto-generated random-input case 044 of 100.
...
RSpec.describe Publisher, type: :model do
  it "is valid with a random name (case 044)" do
    expect(build(:publisher, name: "Christiansen, Daniel and Zemlak 062fec")).to be_valid
  end
end
