...
# Auto-generated random-input case 065 of 100.
...
RSpec.describe Publisher, type: :model do
  it "is valid with a random name (case 065)" do
    expect(build(:publisher, name: "Rodriguez, McClure and Paucek 13f010")).to be_valid
  end
end
