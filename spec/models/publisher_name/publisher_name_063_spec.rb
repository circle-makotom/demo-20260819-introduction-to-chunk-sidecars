...
# Auto-generated random-input case 063 of 100.
...
RSpec.describe Publisher, type: :model do
  it "is valid with a random name (case 063)" do
    expect(build(:publisher, name: "Hartmann, Rowe and Ernser 956efa")).to be_valid
  end
end
