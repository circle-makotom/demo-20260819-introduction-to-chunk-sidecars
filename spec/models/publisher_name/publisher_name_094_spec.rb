...
# Auto-generated random-input case 094 of 100.
...
RSpec.describe Publisher, type: :model do
  it "is valid with a random name (case 094)" do
    expect(build(:publisher, name: "Skiles, Feest and Gislason c2994d")).to be_valid
  end
end
