...
# Auto-generated random-input case 040 of 100.
...
RSpec.describe Publisher, type: :model do
  it "is valid with a random name (case 040)" do
    expect(build(:publisher, name: "Harris, Mills and Wintheiser 8b2dd4")).to be_valid
  end
end
